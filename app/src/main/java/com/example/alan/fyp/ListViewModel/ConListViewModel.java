...
public class ConListViewModel extends ViewModel{

    public final ObservableList<ConViewModel> items = new ObservableArrayList<ConViewModel>();
    public final ItemBinding<ConViewModel> itemBinding = ItemBinding.of(BR.conversation, R.layout.list_conversation);
