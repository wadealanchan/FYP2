...
package com.example.alan.fyp.photoeditor.widget;
...
public class ViewDragHelper {
     ...
     *
     * @param v View to dialog_bottom_sheet for horizontal scrollability
     ...
     * will return false.
     *
     * @param x X position to dialog_bottom_sheet in the parent's coordinate system
     * @param y Y position to dialog_bottom_sheet in the parent's coordinate system
